...
export default class AromaAdsAfterHeader extends Component {
  ...
  get shouldShowAds() {
    ...
    return this.siteSettings.aroma_ads_after_header_enabled;
  }
  
  get adHtml() {
    return this.siteSettings.aroma_ads_after_header_html || "";
  }
}
